...
class FloatSam():
    def __init__(self,
        ...
        # --- THE DUAL-FRAME CONTRACT ---
        if self.use_sim:
            self.GLOBAL_MAP_FRAME: str = 'unity_origin' # Shared Sim Universe
            self.LOCAL_MAP_FRAME: str  = 'unity_origin' # Local Sim Brain
        else:
            self.GLOBAL_MAP_FRAME: str = 'map'               # Shared Hardware Universe
            self.LOCAL_MAP_FRAME: str  = f"{robot_name}/map" # Local Hardware Brain
